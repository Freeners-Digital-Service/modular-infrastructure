...
const adminWebsites = require("./routes/adminWebsites");
const adminConfigure = require("./routes/adminConfigure");
...
const adminAgentTaskAssignments = require("./routes/adminAgentTaskAssignments");
const adminAgentTaskLogs = require("./routes/adminAgentTaskLogs");
...
const adminAgentCapabilities = require("./routes/adminAgentCapabilities");
...
app.use("/admin",  adminSystems(pool, renderPage));
app.use("/admin",  adminModules(pool, renderPage));
app.use("/admin",  adminAgents(pool, renderPage));
app.use("/admin",  adminClientSystems(pool, renderPage));
app.use("/admin",  adminSystemModules(pool, renderPage));
app.use("/admin",  adminModuleAgents(pool, renderPage));
app.use("/admin",  adminWebsites(pool, renderPage));
app.use("/admin", adminConfigure(pool, renderPage));
app.use("/admin",  adminAgentSessions(pool, renderPage));
app.use("/admin",  adminAgentTasks(pool, renderPage));
app.use("/admin",  adminUsers(pool, renderPage));
app.use("/admin",  adminActivityLogs(pool, renderPage));
app.use("/admin",  adminSystemLogs(pool, renderPage));
app.use("/admin",  adminAlerts(pool, renderPage));
app.use("/admin",  adminAnalyticsEvents(pool, renderPage));
app.use("/admin",  adminSystemHealth(pool, renderPage));
app.use("/admin",  adminDeployments(pool, renderPage));
app.use("/admin",  adminPricing(pool, renderPage));
...
app.use("/admin",  adminAgentTaskAssignments(pool, renderPage));
app.use("/admin",  adminAgentTaskLogs(pool, renderPage));
